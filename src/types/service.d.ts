...
import { IDataType } from "src/types/datatype";
import { IIdentifier } from "src/types/identifier";
import { AllSchemas } from "src/types/models";
import { IPurpose } from "src/types/purpose";
...
export interface IService extends AllSchemas {
	...
	/**
	 * @todo use query by service on purpose model instead
	 */
	purposes?: Types.ObjectId[];

	/**
	 * @todo use query by service on datatypes model instead
	 */
	...
	/**
	 * @todo in favor of query byService on identifier model
	 */
