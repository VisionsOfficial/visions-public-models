...
var statics = function (schema) {
    schema.statics.findByServiceList = function (serviceList) {
        return __awaiter(this, void 0, void 0, function () {
            var query, _i, serviceList_1, service, serviceImportQuery, _a, serviceList_2, nestedService, result;
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        for (_i = 0, serviceList_1 = serviceList; _i < serviceList_1.length; _i++) {
                            ...
                            for (_a = 0, serviceList_2 = serviceList; _a < serviceList_2.length; _a++) {
                                nestedService = serviceList_2[_a];
