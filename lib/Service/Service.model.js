...
exports.serviceSchema = new mongoose_1.Schema({
    ...
    purposes: [{ type: mongoose_1.Types.ObjectId, ref: "Purpose" }],
    datatypes: [{ type: mongoose_1.Types.ObjectId, ref: "DataType" }],
    processors: [{ type: mongoose_1.Types.ObjectId, ref: "Processor" }],
    isProcessing: {
        type: Boolean,
        default: false,
    },
    identifiers: [{ type: mongoose_1.Types.ObjectId, ref: "Identifier" }],
    serviceKey: String,
